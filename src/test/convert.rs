...
fn var_format() {
    ...
    t.env("ST_FORMAT", "fasta").cmp(&["."], fa, fa);
    t.env("ST_FORMAT", "fastq").cmp(&["."], fq, fq);
    // t.env("ST_FORMAT", "tsv:id,seq").cmp(&["."], tsv, tsv);
    t.env("ST_FORMAT", "fastq").cmp(&[".", "--to-fa"], fq, fa);
    t.env("ST_FORMAT", "fastq")
